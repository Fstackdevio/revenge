                                ...
                                <div class="account-box">
                                    ...
                                    <div class="account-content">
                                        <div class="m-b-10 text-center">
                                            ...
                                            <p class="text-muted font-13 m-t-10"> A email has been send to you.
                                                Please check for an email from company and click on the included link to
                                                activate your account. </p>

                                            <a href="page-login.php" class="btn btn-md btn-block btn-primary waves-effect waves-light m-t-30">Go to Login</a>
                                        </div>
