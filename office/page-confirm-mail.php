                                    ...
                                    <div class="account-content">
                                        <div class="m-b-10 text-center">
                                            ...
                                            <?php 
                                                $mail = $_GET['mail'];
                                            ?>
                                            <p class="text-muted font-13 m-t-10"> A email has been send to <b><?php echo $mail; ?></b>.
                                                Please check for an email from company and click on the included link to
                                                reset your password. </p>

                                            <a href="page-login.php" class="btn btn-md btn-block btn-primary waves-effect waves-light m-t-30">Back to Home</a>
                                        </div>
